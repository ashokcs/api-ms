...
Set-AzApiManagementPolicy -Context $ApiMgmtContext -ApiId "accounts-api" -OperationId "newGenerateCodeUsingPOST" -PolicyFilePath "$pwd/src/private/verifier_policy.xml"
