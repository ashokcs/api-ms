...
$null = New-AzApiManagementProperty -Context $ApiMgmtContext -PropertyId "urlTransactionsHistory" -Name "urlTransactionsHistory" -Value $transactionsHistoryIp"8081"
...
Import-Secure-Api -context $ApiMgmtContext -msName "transactionsHistory" -sufix "/private" -path "/v1/transactions-history" -apiId "transactions-history" -serviceBase "http://$transactionsHistoryIp`:8081"
